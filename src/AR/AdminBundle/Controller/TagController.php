...
use AR\ArticleBundle\Entity\Tag;
use AR\AdminBundle\Form\TagType;
...
class TagController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ARArticleBundle:Tag')->findAll();
     ...
     * @Method("POST")
     * @Template("ARArticleBundle:Tag:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ARArticleBundle:Tag')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("ARArticleBundle:Tag:edit.html.twig")
     */
